...
PROFILES = {
    "4:3": LayoutProfile(
        ...
        search_toggle_x_ratio=0.380,
        search_toggle_y_ratio=0.232,
        ...
        search_input_y_ratio=0.302,
        search_row_roi_y=(0.22, 0.37),
        search_input_left_of_execute_ratio=0.14,
        search_box_roi_height_ratio=0.36,
        filter_clear_roi_x=(0.28, 0.72),
        filter_clear_roi_y=(0.20, 0.32),
        filter_clear_x_ratio=0.50,
        filter_clear_y_ratio=0.248,
    ...
    "16:9": LayoutProfile(
        ...
        first_result_row_y_ratio=0.50,
        search_toggle_x_ratio=0.366,
        search_toggle_y_ratio=0.230,
        ...
        search_input_y_ratio=0.300,
        search_row_roi_y=(0.22, 0.36),
        search_input_left_of_execute_ratio=0.14,
        search_box_roi_height_ratio=0.35,
        filter_clear_roi_x=(0.30, 0.70),
        filter_clear_roi_y=(0.19, 0.30),
        filter_clear_x_ratio=0.48,
        filter_clear_y_ratio=0.242,
    ...
    "21:9": LayoutProfile(
        ...
        first_result_row_y_ratio=0.50,
        search_toggle_x_ratio=0.340,
        search_toggle_y_ratio=0.228,
        ...
        search_input_y_ratio=0.296,
        search_row_roi_y=(0.21, 0.35),
        search_input_left_of_execute_ratio=0.12,
        search_box_roi_height_ratio=0.34,
        filter_clear_roi_x=(0.32, 0.68),
        filter_clear_roi_y=(0.18, 0.29),
        filter_clear_x_ratio=0.46,
        filter_clear_y_ratio=0.238,
